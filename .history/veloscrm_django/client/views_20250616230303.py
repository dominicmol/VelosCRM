...
class NoteViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        try:
            ...
            raise Http404("Client not found or does not belong to your team.")
...
def delete_client(request, client_id):
    ...
    try:
        ...
        client.delete()
        return Response({'message': 'The client was deleted'}, status=status.HTTP_200_OK)
    except Client.DoesNotExist:
        return Response({'detail': 'Client niet gevonden of behoort niet tot jouw team.'}, status=status.HTTP_404_NOT_FOUND)